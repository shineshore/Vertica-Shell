...
truncate table BSSDATA.PAR_DEPT;

COPY BSSDATA.PAR_DEPT FROM '/data/SOURCE/case4.1.5/BSSDATA_PAR_DEPT_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10  NO ESCAPE;
