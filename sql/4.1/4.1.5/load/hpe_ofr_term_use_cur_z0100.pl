...
truncate table ZJBIC.OFR_TERM_USE_CUR_Z;

COPY ZJBIC.OFR_TERM_USE_CUR_Z FROM '/data/SOURCE/case4.1.5/ZJBIC_OFR_TERM_USE_CUR_Z_*.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10;
