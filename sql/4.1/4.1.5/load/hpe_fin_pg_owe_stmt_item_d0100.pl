...
truncate table BSSDATA.FIN_PG_OWE_STMT_ITEM_D_${LocalCode};

COPY BSSDATA.FIN_PG_OWE_STMT_ITEM_D_${LocalCode} FROM '/data/SOURCE/case4.1.5/BSSDATA_FIN_PG_OWE_STMT_ITEM_D_${LocalCode}_*.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10 NO ESCAPE  TRAILING NULLCOLS;
