...
truncate table BSSDATA.OFR_MKT_CHANNEL_${LocalCode};

COPY BSSDATA.OFR_MKT_CHANNEL_${LocalCode} FROM '/data/SOURCE/case4.1.5/BSSDATA_OFR_MKT_CHANNEL_${LocalCode}_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10;
