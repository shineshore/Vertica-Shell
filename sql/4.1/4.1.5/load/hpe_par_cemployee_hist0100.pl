...
truncate table BSSDATA.PAR_CEMPLOYEE_HIST;

COPY BSSDATA.PAR_CEMPLOYEE_HIST FROM '/data/SOURCE/case4.1.5/BSSDATA_PAR_CEMPLOYEE_HIST_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10 NO ESCAPE;
