...
truncate table ZJBIC.OFR_MAIN_ASSET_CUR_A;

COPY ZJBIC.OFR_MAIN_ASSET_CUR_A FROM '/data/SOURCE/case4.1.5_3/OFR_MAIN_ASSET_CUR_A_20170731_T.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10  NO ESCAPE  TRAILING NULLCOLS;
