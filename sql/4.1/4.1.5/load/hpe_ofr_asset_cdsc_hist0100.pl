...
truncate table BSSDATA.OFR_ASSET_CDSC_HIST_${LocalCode};

COPY BSSDATA.OFR_ASSET_CDSC_HIST_${LocalCode} FROM '/data/SOURCE/case4.1.5/BSSDATA_OFR_ASSET_CDSC_HIST_${LocalCode}_*.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10;
