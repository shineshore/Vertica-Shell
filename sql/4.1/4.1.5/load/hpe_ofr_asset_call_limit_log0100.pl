...
truncate table BSSDATA.OFR_ASSET_CALL_LIMIT_LOG_${LocalCode};

COPY BSSDATA.OFR_ASSET_CALL_LIMIT_LOG_${LocalCode} FROM '/data/SOURCE/case4.1.5_2/BSSDATA_OFR_ASSET_CALL_LIMIT_LOG_${LocalCode}_*_T.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10 NO ESCAPE  TRAILING NULLCOLS;
