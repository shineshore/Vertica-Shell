...
truncate table BSSDATA.OFR_CPRD;

COPY BSSDATA.OFR_CPRD FROM '/data/SOURCE/case4.1.5/BSSDATA_OFR_CPRD_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10;
