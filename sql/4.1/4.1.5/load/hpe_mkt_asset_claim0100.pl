...
truncate table BSSDATA.MKT_ASSET_CLAIM_${LocalCode};

COPY BSSDATA.MKT_ASSET_CLAIM_${LocalCode} FROM '/data/SOURCE/case4.1.5/BSSDATA_MKT_ASSET_CLAIM_${LocalCode}_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10 NO ESCAPE  TRAILING NULLCOLS;
