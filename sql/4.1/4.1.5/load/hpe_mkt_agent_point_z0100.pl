...
truncate table BSSDATA.MKT_AGENT_POINT_Z;

COPY BSSDATA.MKT_AGENT_POINT_Z FROM '/data/SOURCE/case4.1.5/BSSDATA_MKT_AGENT_POINT_Z_20170609_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10  NO ESCAPE;
