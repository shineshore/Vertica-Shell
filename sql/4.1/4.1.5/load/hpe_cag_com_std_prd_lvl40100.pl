...
truncate table DMN.CAG_COM_STD_PRD_LVL4;

COPY DMN.CAG_COM_STD_PRD_LVL4 FROM '/data/SOURCE/case4.1.5/DMN_CAG_COM_STD_PRD_LVL4_0001.dat' ON ANY NODE DELIMITER E'\007' DIRECT REJECTMAX 10;
