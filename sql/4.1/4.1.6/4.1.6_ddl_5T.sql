CREATE SCHEMA TPCDS_5T;


CREATE TABLE tpcds_5t.dbgen_version
(
...
CREATE TABLE tpcds_5t.customer_address
(
...
CREATE TABLE tpcds_5t.customer_demographics
(
...
CREATE TABLE tpcds_5t.date_dim
(
...
CREATE TABLE tpcds_5t.warehouse
(
...
CREATE TABLE tpcds_5t.ship_mode
(
...
CREATE TABLE tpcds_5t.time_dim
(
...
CREATE TABLE tpcds_5t.income_band
(
...
CREATE TABLE tpcds_5t.call_center
(
...
CREATE TABLE tpcds_5t.customer
(
...
CREATE TABLE tpcds_5t.web_site
(
...
CREATE TABLE tpcds_5t.store_returns
(
...
CREATE TABLE tpcds_5t.household_demographics
(
...
CREATE TABLE tpcds_5t.web_page
(
...
CREATE TABLE tpcds_5t.promotion
(
...
CREATE TABLE tpcds_5t.catalog_page
(
...
CREATE TABLE tpcds_5t.inventory
(
...
CREATE TABLE tpcds_5t.catalog_returns
(
...
CREATE TABLE tpcds_5t.web_returns
(
...
CREATE TABLE tpcds_5t.web_sales
(
    ws_sold_date_sk int,
    ws_sold_time_sk int,
    ws_ship_date_sk int,
...
CREATE TABLE tpcds_5t.catalog_sales
(
    cs_sold_date_sk int,
    cs_sold_time_sk int,
    cs_ship_date_sk int,
...
CREATE TABLE tpcds_5t.store_sales
(
    ss_sold_date_sk int,
    ss_sold_time_sk int,
...
CREATE PROJECTION tpcds_5t.dbgen_version_DBD_1_seg_test132_b0 /*+basename(dbgen_version_DBD_1_seg_test132),createtype(D)*/
(
...
AS
 SELECT dv_version, 
        ...
        dv_create_time, 
        dv_cmdline_args
 FROM tpcds_5t.dbgen_version 
 ORDER BY dv_version
SEGMENTED BY MODULARHASH (dv_version) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.dbgen_version_DBD_1_seg_test132_b1 /*+basename(dbgen_version_DBD_1_seg_test132),createtype(D)*/
(
 dv_version ENCODING AUTO, 
 dv_create_date ENCODING AUTO, 
 dv_create_time ENCODING AUTO, 
...
CREATE PROJECTION tpcds_5t.customer_address_DBD_2_rep_test132 /*+createtype(D)*/
(
...
AS
 SELECT ca_address_sk, 
        ...
        ca_gmt_offset, 
        ca_location_type
 FROM tpcds_5t.customer_address 
 ORDER BY ca_state,
          ca_gmt_offset,
          ca_country,
          ca_location_type,
...
CREATE PROJECTION tpcds_5t.customer_demographics_DBD_41_seg_test132_b0 /*+basename(customer_demographics_DBD_41_seg_test132),createtype(D)*/
(
...
AS
 ...
 FROM tpcds_5t.customer_demographics 
 ORDER BY cd_demo_sk
SEGMENTED BY HASH (cd_demo_sk) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.customer_demographics_DBD_41_seg_test132_b1 /*+basename(customer_demographics_DBD_41_seg_test132),createtype(D)*/
(
 cd_demo_sk ENCODING COMMONDELTA_COMP, 
 cd_gender ENCODING AUTO, 
 cd_marital_status ENCODING AUTO, 
...
CREATE PROJECTION tpcds_5t.date_dim_DBD_3_rep_test132 /*+createtype(D)*/
(
...
AS
 SELECT d_date_sk, 
        ...
        d_current_quarter, 
        d_current_year
 FROM tpcds_5t.date_dim 
 ORDER BY d_year,
          d_date_sk
UNSEGMENTED ALL NODES;

CREATE PROJECTION tpcds_5t.date_dim_DBD_42_seg_test132_b0 /*+basename(date_dim_DBD_42_seg_test132),createtype(D)*/
(
 d_date_sk ENCODING COMMONDELTA_COMP, 
 d_date_id ENCODING AUTO, 
 d_date ENCODING COMMONDELTA_COMP, 
...
CREATE PROJECTION tpcds_5t.date_dim_DBD_42_seg_test132_b1 /*+basename(date_dim_DBD_42_seg_test132),createtype(D)*/
(
 d_date_sk ENCODING COMMONDELTA_COMP, 
 d_date_id ENCODING AUTO, 
 d_date ENCODING COMMONDELTA_COMP, 
...
CREATE PROJECTION tpcds_5t.ship_mode_DBD_4_rep_test132 /*+createtype(D)*/
(
...
AS
 SELECT sm_ship_mode_sk, 
        ...
        sm_carrier, 
        sm_contract
 FROM tpcds_5t.ship_mode 
 ORDER BY sm_ship_mode_sk
UNSEGMENTED ALL NODES;

CREATE PROJECTION tpcds_5t.time_dim_DBD_5_rep_test132 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.reason_DBD_6_rep_test132 /*+createtype(D)*/
(
...
AS
 SELECT r_reason_sk, 
        r_reason_id, 
        r_reason_desc
 FROM tpcds_5t.reason 
 ORDER BY r_reason_sk
UNSEGMENTED ALL NODES;

CREATE PROJECTION tpcds_5t.income_band_DBD_7_rep_test132 /*+createtype(D)*/
(
...
AS
 SELECT ib_income_band_sk, 
        ib_lower_bound, 
        ib_upper_bound
 FROM tpcds_5t.income_band 
 ORDER BY ib_income_band_sk
UNSEGMENTED ALL NODES;

CREATE PROJECTION tpcds_5t.item_DBD_8_rep_test132 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.item_DBD_9_rep_test132 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.item_DBD_44_seg_test132_b0 /*+basename(item_DBD_44_seg_test132),createtype(D)*/
(
 i_item_sk ENCODING COMMONDELTA_COMP, 
 i_item_id ENCODING AUTO, 
 i_rec_start_date ENCODING BLOCKDICT_COMP, 
...
CREATE PROJECTION tpcds_5t.item_DBD_44_seg_test132_b1 /*+basename(item_DBD_44_seg_test132),createtype(D)*/
(
 i_item_sk ENCODING COMMONDELTA_COMP, 
 i_item_id ENCODING AUTO, 
 i_rec_start_date ENCODING BLOCKDICT_COMP, 
...
CREATE PROJECTION tpcds_5t.store_DBD_45_seg_test132_b0 /*+basename(store_DBD_45_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.store_DBD_45_seg_test132_b1 /*+basename(store_DBD_45_seg_test132),createtype(D)*/
(
 s_store_sk ENCODING AUTO, 
 s_store_id ENCODING AUTO, 
 s_rec_start_date ENCODING AUTO, 
...
CREATE PROJECTION tpcds_5t.customer_DBD_10_rep_test132 /*+createtype(D)*/
(
...
AS
 SELECT c_customer_sk, 
        ...
        c_email_address, 
        c_last_review_date
 FROM tpcds_5t.customer 
 ORDER BY c_customer_sk
UNSEGMENTED ALL NODES;

CREATE PROJECTION tpcds_5t.customer_DBD_47_seg_test132_b0 /*+basename(customer_DBD_47_seg_test132),createtype(D)*/
(
 c_customer_sk ENCODING COMMONDELTA_COMP, 
 c_customer_id ENCODING AUTO, 
 c_current_cdemo_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION tpcds_5t.customer_DBD_47_seg_test132_b1 /*+basename(customer_DBD_47_seg_test132),createtype(D)*/
(
 c_customer_sk ENCODING COMMONDELTA_COMP, 
 c_customer_id ENCODING AUTO, 
 c_current_cdemo_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION tpcds_5t.web_site_DBD_11_rep_test132 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.store_returns_DBD_12_seg_test132_b0 /*+basename(store_returns_DBD_12_seg_test132),createtype(D)*/
(
...
AS
 SELECT sr_returned_date_sk, 
        ...
        sr_store_credit, 
        sr_net_loss
 FROM tpcds_5t.store_returns 
 ORDER BY sr_item_sk,
          sr_ticket_number
SEGMENTED BY MODULARHASH (sr_item_sk, sr_ticket_number) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.store_returns_DBD_12_seg_test132_b1 /*+basename(store_returns_DBD_12_seg_test132),createtype(D)*/
(
 sr_returned_date_sk ENCODING DELTAVAL, 
 sr_return_time_sk ENCODING DELTAVAL, 
 sr_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.store_returns_DBD_48_seg_test132_b0 /*+basename(store_returns_DBD_48_seg_test132),createtype(D)*/
(
 sr_returned_date_sk ENCODING DELTAVAL, 
 sr_return_time_sk ENCODING DELTAVAL, 
 sr_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.store_returns_DBD_48_seg_test132_b1 /*+basename(store_returns_DBD_48_seg_test132),createtype(D)*/
(
 sr_returned_date_sk ENCODING DELTAVAL, 
 sr_return_time_sk ENCODING DELTAVAL, 
 sr_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.household_demographics_DBD_49_seg_test132_b0 /*+basename(household_demographics_DBD_49_seg_test132),createtype(D)*/
(
...
AS
 SELECT hd_demo_sk, 
        ...
        hd_dep_count, 
        hd_vehicle_count
 FROM tpcds_5t.household_demographics 
 ORDER BY hd_demo_sk
SEGMENTED BY HASH (hd_demo_sk) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.household_demographics_DBD_49_seg_test132_b1 /*+basename(household_demographics_DBD_49_seg_test132),createtype(D)*/
(
 hd_demo_sk ENCODING COMMONDELTA_COMP, 
 hd_income_band_sk ENCODING COMMONDELTA_COMP, 
 hd_buy_potential ENCODING AUTO, 
...
CREATE PROJECTION tpcds_5t.web_page_DBD_13_rep_test132 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.promotion_DBD_50_seg_test132_b0 /*+basename(promotion_DBD_50_seg_test132),createtype(D)*/
(
...
AS
 SELECT p_promo_sk, 
        ...
        p_purpose, 
        p_discount_active
 FROM tpcds_5t.promotion 
 ORDER BY p_promo_sk
SEGMENTED BY HASH (p_promo_sk) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.promotion_DBD_50_seg_test132_b1 /*+basename(promotion_DBD_50_seg_test132),createtype(D)*/
(
 p_promo_sk ENCODING COMMONDELTA_COMP, 
 p_promo_id ENCODING AUTO, 
 p_start_date_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION tpcds_5t.catalog_page_DBD_14_rep_test132 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.inventory_DBD_51_seg_test132_b0 /*+basename(inventory_DBD_51_seg_test132),createtype(D)*/
(
...
AS
 ...
 FROM tpcds_5t.inventory 
 ORDER BY inv_date_sk,
          inv_item_sk,
          inv_warehouse_sk
SEGMENTED BY HASH (inv_date_sk, inv_item_sk, inv_warehouse_sk) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.inventory_DBD_51_seg_test132_b1 /*+basename(inventory_DBD_51_seg_test132),createtype(D)*/
(
 inv_date_sk ENCODING RLE, 
 inv_item_sk ENCODING COMMONDELTA_COMP, 
 inv_warehouse_sk ENCODING BLOCKDICT_COMP, 
...
CREATE PROJECTION tpcds_5t.catalog_returns_DBD_15_seg_test132_b0 /*+basename(catalog_returns_DBD_15_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.catalog_returns_DBD_15_seg_test132_b1 /*+basename(catalog_returns_DBD_15_seg_test132),createtype(D)*/
(
 cr_returned_date_sk ENCODING RLE, 
 cr_returned_time_sk ENCODING DELTAVAL, 
 cr_item_sk ENCODING BLOCKDICT_COMP, 
...
CREATE PROJECTION tpcds_5t.catalog_returns_DBD_52_seg_test132_b0 /*+basename(catalog_returns_DBD_52_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.catalog_returns_DBD_52_seg_test132_b1 /*+basename(catalog_returns_DBD_52_seg_test132),createtype(D)*/
(
 cr_returned_date_sk ENCODING COMMONDELTA_COMP, 
 cr_returned_time_sk ENCODING DELTAVAL, 
 cr_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.web_returns_DBD_16_seg_test132_b0 /*+basename(web_returns_DBD_16_seg_test132),createtype(D)*/
(
...
AS
 SELECT wr_returned_date_sk, 
        ...
        wr_account_credit, 
        wr_net_loss
 FROM tpcds_5t.web_returns 
 ORDER BY wr_item_sk,
          wr_order_number
SEGMENTED BY MODULARHASH (wr_item_sk, wr_order_number) ALL NODES OFFSET 0;

CREATE PROJECTION tpcds_5t.web_returns_DBD_16_seg_test132_b1 /*+basename(web_returns_DBD_16_seg_test132),createtype(D)*/
(
 wr_returned_date_sk ENCODING DELTAVAL, 
 wr_returned_time_sk ENCODING DELTAVAL, 
 wr_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.web_sales_DBD_17_seg_test132_b0 /*+basename(web_sales_DBD_17_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.web_sales_DBD_17_seg_test132_b1 /*+basename(web_sales_DBD_17_seg_test132),createtype(D)*/
(
 ws_sold_date_sk ENCODING RLE, 
 ws_sold_time_sk ENCODING DELTAVAL, 
 ws_ship_date_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION tpcds_5t.catalog_sales_DBD_18_seg_test132_b0 /*+basename(catalog_sales_DBD_18_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.catalog_sales_DBD_19_seg_test132_b0 /*+basename(catalog_sales_DBD_19_seg_test132),createtype(D)*/
(
 cs_item_sk ENCODING RLE
)
AS
...
CREATE PROJECTION tpcds_5t.catalog_sales_DBD_18_seg_test132_b1 /*+basename(catalog_sales_DBD_18_seg_test132),createtype(D)*/
(
 cs_sold_date_sk ENCODING RLE, 
 cs_sold_time_sk ENCODING DELTAVAL, 
 cs_ship_date_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION tpcds_5t.catalog_sales_DBD_19_seg_test132_b1 /*+basename(catalog_sales_DBD_19_seg_test132),createtype(D)*/
(
 cs_item_sk ENCODING RLE
)
AS
...
CREATE PROJECTION tpcds_5t.catalog_sales_DBD_53_seg_test132_b0 /*+basename(catalog_sales_DBD_53_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.catalog_sales_DBD_53_seg_test132_b1 /*+basename(catalog_sales_DBD_53_seg_test132),createtype(D)*/
(
 cs_sold_date_sk ENCODING DELTARANGE_COMP, 
 cs_sold_time_sk ENCODING DELTAVAL, 
 cs_ship_date_sk ENCODING COMMONDELTA_COMP, 
...
CREATE PROJECTION tpcds_5t.store_sales_DBD_20_seg_test132_b0 /*+basename(store_sales_DBD_20_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.store_sales_DBD_20_seg_test132_b1 /*+basename(store_sales_DBD_20_seg_test132),createtype(D)*/
(
 ss_sold_date_sk ENCODING RLE, 
 ss_sold_time_sk ENCODING DELTAVAL, 
 ss_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.store_sales_DBD_54_seg_test132_b0 /*+basename(store_sales_DBD_54_seg_test132),createtype(D)*/
(
...
CREATE PROJECTION tpcds_5t.store_sales_DBD_54_seg_test132_b1 /*+basename(store_sales_DBD_54_seg_test132),createtype(D)*/
(
 ss_sold_date_sk ENCODING DELTAVAL, 
 ss_sold_time_sk ENCODING DELTAVAL, 
 ss_item_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds_5t.call_center_b0 /*+basename(call_center),createtype(P)*/ 
(
 cc_call_center_sk,
 cc_call_center_id,
 cc_rec_start_date,
...
CREATE PROJECTION tpcds_5t.catalog_sales_Manual_53_seg_test1 /*+createtype(D)*/ 
(
 cs_sold_date_sk ENCODING DELTARANGE_COMP,
 cs_sold_time_sk ENCODING DELTAVAL,
 cs_ship_date_sk ENCODING COMMONDELTA_COMP,
...
--DROP PROJECTION tpcds_5t.store_sales_Manual_201_seg_test1;
CREATE PROJECTION tpcds_5t.store_sales_Manual_201_seg_test1 /*+createtype(D)*/ 
(
 ss_sold_date_sk ENCODING RLE,
 ss_sold_time_sk ENCODING DELTAVAL,
 ss_item_sk ENCODING RLE,
...
--drop PROJECTION tpcds_5t.web_sales_Manual_17_seg_test1;
CREATE PROJECTION tpcds_5t.web_sales_Manual_17_seg_test1 /*+createtype(D)*/ 
(
 ws_sold_date_sk ENCODING RLE,
 ws_sold_time_sk ENCODING DELTAVAL,
 ws_ship_date_sk ENCODING DELTAVAL,
...
--select refresh('tpcds_5t.web_sales,tpcds_5t.store_sales, tpcds_5t.catalog_sales');
--select make_ahm_now();
