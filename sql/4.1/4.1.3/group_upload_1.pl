...
----【3.2】数据插入目标表    
--/* haoyf */DELETE FROM ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
--/* haoyf */WHERE  DAY_ID =  '${TX_N_DATE}' or DAY_ID = '$Begfore_Day2_Yyyy_Mm_N_Dd'
DELETE FROM ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
WHERE  DAY_ID =  '${TX_N_DATE}' or DAY_ID = '$Begfore_Day2_Yyyy_Mm_N_Dd'
;

--/* haoyf*/INSERT INTO ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
INSERT INTO ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
(
DAY_ID                                                
,LATN_ID                      
,OFFER_INST_ID                
...
,EXT_PROD_OFFER_INST_ID                                     -----------V1.1             
        ...
        SELECT 
                            ...
                            ,EXT_PROD_OFFER_INST_ID                                     -----------V1.1    
          --/* haoyf*/  from        ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
		    from        ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
...
MERGE INTO ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1 AS P1
USING 
(
SELECT                            
DAY_ID                                                
...
--/* haoyf*/UPDATE ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
UPDATE ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1
...
MERGE INTO 
--/* haoyf*/ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1 AS P1 
ITFJYFX_1.DAPD_PRD_PO_INST_${LocalCode}_1 AS P1 
USING 
(
SELECT 
