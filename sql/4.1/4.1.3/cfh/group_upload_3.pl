...
----【3.2】数据插入目标表    
--/* haoyf */DELETE FROM ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
--/* haoyf */WHERE  DAY_ID =  '${TX_N_DATE}' or DAY_ID = '$Begfore_Day2_Yyyy_Mm_N_Dd'
DELETE FROM ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
WHERE  DAY_ID =  '${TX_N_DATE}' or DAY_ID = '$Begfore_Day2_Yyyy_Mm_N_Dd'
;

--/* haoyf*/INSERT INTO ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
INSERT INTO ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
(
DAY_ID                                                
,LATN_ID                      
,OFFER_INST_ID                
...
,EXT_PROD_OFFER_INST_ID                                     -----------V1.1             
        ...
        SELECT 
                            ...
                            ,EXT_PROD_OFFER_INST_ID                                     -----------V1.1    
          --/* haoyf*/  from        ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
		    from        ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
...
MERGE INTO ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3 AS P1
USING 
(
SELECT                            
DAY_ID                                                
...
--/* haoyf*/UPDATE ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
UPDATE ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3
...
MERGE INTO 
--/* haoyf*/ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3 AS P1 
ITFJYFX_2.DAPD_PRD_PO_INST_${LocalCode}_3 AS P1 
USING 
(
SELECT 
