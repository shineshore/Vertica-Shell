...
CREATE LOCAL TEMP TABLE NEW_BIL_FLG_${LocalCode}_3 ON COMMIT PRESERVE ROWS
AS
(
		SELECT
							P1.ASSET_ROW_ID
...
SELECT ASSET_ROW_ID,BIL_FLG FROM (								  
		SELECT
			...
			FROM		NEW_BIL_FLG_${LocalCode}_3 P1 --??? orignal 1
...
DELETE FROM KPI_2.KPI_ASSET_FLG_${LocalCode}_3
WHERE DATE_CD = TO_DATE('$TX_DATE' ,  'YYYYMMDD')
   OR (DATE_CD <= TO_DATE('$TX_DATE' ,  'YYYYMMDD') - 62 )
;   


INSERT INTO KPI_2.KPI_ASSET_FLG_${LocalCode}_3
SELECT
Asset_Row_Id
,Date_Cd
,Bil_Flg
...
CREATE LOCAL TEMP TABLE TMP_OFR_MAIN_ASSET_${LocalCode}_3_TMP ON COMMIT PRESERVE ROWS  --???? Original 1
AS
(
select
P1.ASSET_ROW_ID
...
INNER join KPI_2.KPI_ASSET_FLG_${LocalCode}_3   P3
...
CREATE LOCAL TEMP TABLE TMP_OFR_MAIN_ASSET_${LocalCode}_3 ON COMMIT PRESERVE ROWS
AS
(
select 
P1.ASSET_ROW_ID
...
FROM TMP_OFR_MAIN_ASSET_${LocalCode}_3_TMP   P1
...
INNER join TMP_OFR_MAIN_ASSET_${LocalCode}_3  P2
ON P1.ASSET_ROW_ID = P2.ASSET_ROW_ID
and P2.Free_Flg = 0
...
DELETE FROM KPI_2.KPI_ASSET_TER_${LocalCode}_3
WHERE (DATE_CD = TO_DATE('$TX_DATE'  , 'YYYYMMDD') or DATE_CD < TO_DATE('$TX_DATE'  , 'YYYYMMDD') - 62 )
;

INSERT INTO KPI_2.KPI_ASSET_TER_${LocalCode}_3
(
Date_Cd
,Esn_Id
,Esn_New_Dt
...
LEFT join KPI_2.KPI_ASSET_TER_${LocalCode}_3  p3
...
CREATE LOCAL TEMP table ORDI_${LocalCode}_3_PRE3 ON COMMIT PRESERVE ROWS
AS(
SELECT    
                   P.Order_Item_Row_Id
                  ,P.Instant_Flg   
...
SELECT    
                  ...
                  ,P.Last_Display_Area_Id
                  ,P.Last_Display_Area_Name             
          FROM    ORDI_${LocalCode}_3_PRE3                  P                                              
    LEFT JOIN     ZJBIC_2.ORDER_SALE_NAME_ALL_${LocalCode}            P21                 --YY20101201
...
DELETE FROM KPI_2.KPI_ASSET_IO_${LocalCode}_3
WHERE  DATE_CD = TO_DATE('$TX_DATE'  , 'YYYYMMDD')
;
...
INSERT INTO KPI_2.KPI_ASSET_IO_${LocalCode}_3
                (
                  Asset_Integ_Id
                 ,Asset_Row_Id
                 ,DATE_CD
