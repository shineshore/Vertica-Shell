...
SELECT ASSET_ROW_ID,BIL_FLG FROM (								  
		SELECT
			...
			FROM		NEW_BIL_FLG_${LocalCode}_1 P1
...
DELETE FROM KPI_1.KPI_ASSET_FLG_${LocalCode}_1
WHERE DATE_CD = TO_DATE('$TX_DATE' ,  'YYYYMMDD')
   OR (DATE_CD <= TO_DATE('$TX_DATE' ,  'YYYYMMDD') - 62 )
;   


INSERT INTO KPI_1.KPI_ASSET_FLG_${LocalCode}_1
SELECT
Asset_Row_Id
,Date_Cd
,Bil_Flg
...
INNER join KPI_1.KPI_ASSET_FLG_${LocalCode}_1   P3
...
DELETE FROM KPI_1.KPI_ASSET_TER_${LocalCode}_1
WHERE (DATE_CD = TO_DATE('$TX_DATE'  , 'YYYYMMDD') or DATE_CD < TO_DATE('$TX_DATE'  , 'YYYYMMDD') - 62 )
;

INSERT INTO KPI_1.KPI_ASSET_TER_${LocalCode}_1
(
Date_Cd
,Esn_Id
,Esn_New_Dt
...
LEFT join KPI_1.KPI_ASSET_TER_${LocalCode}_1  p3
...
-- ORDER BY Ordi_Row_Id,Order_Item_Row_Id    --haoyf
...
DELETE FROM KPI_1.KPI_ASSET_IO_${LocalCode}_1
WHERE  DATE_CD = TO_DATE('$TX_DATE'  , 'YYYYMMDD')
;
...
INSERT INTO KPI_1.KPI_ASSET_IO_${LocalCode}_1
                (
                  Asset_Integ_Id
                 ,Asset_Row_Id
                 ,DATE_CD
